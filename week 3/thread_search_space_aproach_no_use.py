...
def f1():
    ansf1=[]
    def createrandom(bit_size):
        return random.randrange(0,(2**(bit_size))/2)   
    population_number=8#input('Population Number::')
    global bit_size
    bit_size=8#input('Bit Size::')
    iteration=100#input('Number of generations::')
    ...
    print 'Optimization complete :1'
    print ((((int(compute_counter[:bit_size],2)/float((2**bit_size)-1))*90)),(((int(compute_counter[bit_size:],2)/float((2**bit_size)-1))*90)))
def f2():
    ansf2=[]
    def createrandom(bit_size):
        return random.randrange((2**(bit_size))/2,2**(bit_size))        
    population_number=8#input('Population Number::')
    global bit_size
    bit_size=8#input('Bit Size::')
    iteration=100#input('Number of generations::')
