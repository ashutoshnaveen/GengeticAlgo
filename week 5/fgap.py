...
def compute(x1,x2,upper_limit):
    ...
    c=math.cos
    try:
        return s(x1-2+(rank*(upper_limit_i/3)))/(x1-2+(rank*(upper_limit_i/3))) + s(x2-2+(rank*(upper_limit_i/3)))/(x2-2+(rank*(upper_limit_i/3)))+(s(x1-14+(rank*(upper_limit_i/3)))/(x1-14+(rank*(upper_limit_i/3))) + s(x2-14+(rank*(upper_limit_i/3)))/(x2-14+(rank*(upper_limit_i/3)))+1)
...
if rank ==0:
    ...
    while c_cnt<population_number/2:
        t1=random.randrange(0,population_number/2)
        t2=random.randrange(0,population_number/2)
        if t1!=t2:
